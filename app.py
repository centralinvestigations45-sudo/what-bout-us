...
STANDALONE=['Simone','Chloe','Darius','Isabella','Julius','Malik','Nia']
SPRITE_NAMES=['Alex','Damien','Logan','Jay','Kai','Mason','Ethan','Luca','Noah','Jack','Leo','Carter','Lily','Aria','Mika','Zoey','Nova','Sophia','Ember','Hana','Riley','Vivien','Bella','Sahara','Skye']
def portrait(name):
 if name=='Simone': return '/static/simone.jpg?v=19'
 if name in STANDALONE: return '/static/'+name.lower()+'.jpg?v=19'
 if name in SPRITE_NAMES: return '/portrait/'+name.lower()+'.svg?v=19'
