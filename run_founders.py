...
def _founders_section():
  ...
  <div style="padding:28px;border-radius:26px;background:radial-gradient(circle at 75% 15%,rgba(191,151,73,.18),transparent 35%),linear-gradient(145deg,#080808,#151515);border:1px solid #8f7137;box-shadow:0 18px 50px rgba(0,0,0,.42)">
    <div style="text-align:center;color:#d8b86c;font-size:12px;font-weight:900;letter-spacing:3px">LIMITED FOUNDING MEMBERSHIP</div>
    <h2 style="text-align:center;font-size:clamp(30px,6vw,52px);margin:10px 0 6px">What Bout Us™ Founders Club</h2>
    <p style="text-align:center;color:#c9c3b7;max-width:760px;margin:0 auto 24px;line-height:1.6">Be part of the original What Bout Us™ community and receive a distinctive virtual Black Card that separates Founding Members from standard members throughout the site.</p>
    ...
    <div style="max-width:760px;margin:0 auto 24px;aspect-ratio:1.65;border-radius:24px;padding:4%;position:relative;overflow:hidden;background:#050505;border:2px solid #c6a458;box-shadow:0 16px 42px rgba(0,0,0,.55),inset 0 0 0 2px #181818;color:#d9ba70">
      ...
      <div style="position:relative;display:flex;gap:8%;align-items:flex-end;margin-top:4%;font-size:clamp(9px,1.5vw,14px);letter-spacing:2px"><span>FOUNDING MEMBER</span><span>UNLIMITED ACCESS</span></div>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;max-width:780px;margin:0 auto 24px">
      ...
      <div class="card" style="padding:16px"><b>Unlimited Access</b><div class="sub">Founders-level platform access subject to the membership terms.</div></div>
