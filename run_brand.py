...
def branded_nav():
    return ('<div class="nav"><div class="shell navin">'
            ...
            '<img src="'+LOGO_PATH+'?v=8" alt="What Bout Us™ AI Companions" style="width:72px;height:72px;object-fit:contain;border-radius:12px">'
...
def branded_footer():
    return ('<div class="fine"><img src="'+LOGO_PATH+'?v=8" alt="What Bout Us™ AI Companions" '
...
def branded_page(title, body):
    ...
    image = PUBLIC_URL + LOGO_PATH + '?v=8'
    meta = ('<meta name="description" content="What Bout Us™ — AI companions with conversation, voice, memory and personalized experiences.">'
            ...
            '<meta property="og:image:type" content="image/jpeg"><meta property="og:image:width" content="212"><meta property="og:image:height" content="260">'
            '<meta property="og:image:alt" content="What Bout Us™ AI Companions official logo">'
            '<meta name="twitter:card" content="summary_large_image"><meta name="twitter:title" content="What Bout Us™ — AI Companions">'
            '<meta name="twitter:description" content="Someone to talk to. Someone who remembers."><meta name="twitter:image" content="'+image+'">'
            '<link rel="icon" type="image/jpeg" href="'+LOGO_PATH+'?v=8"><link rel="apple-touch-icon" href="'+LOGO_PATH+'?v=8">')
...
def logo_bytes():
    return base64.b64decode(LOGO_FILE.read_text(encoding='ascii').strip())
