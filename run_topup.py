...
# Real-money purchase: virtual style money is sold ONLY in $5.00 increments.
# Each $5.00 adds $300 in non-cash virtual style money.
# Allowed totals are $5, $10, $15, $20, $25 and so on — no in-between amounts.
...
<section style="max-width:1050px;margin:0 auto 18px">
  <div class="card" style="padding:20px;border:1px solid #57334a">
    ...
    <h2 style="margin:8px 0">Add Virtual Money in $5.00 Increments</h2>
    <p class="sub" style="line-height:1.6">Subscribers can add virtual style money only in multiples of $5.00: $5, $10, $15, $20, $25 and so on. Every $5.00 adds $300 in What Bout Us™ virtual style money after payment is confirmed. No in-between amounts are allowed.</p>
    <a class="btn" href="/style-money/topup">Add Virtual Money</a>
    <a class="btn alt" href="/plans-virtual-money" style="margin-left:8px">How Plans &amp; Virtual Money Work</a>
    <p class="sub" style="font-size:12px;margin-top:10px">$5 = $300 virtual · $10 = $600 · $15 = $900 · $20 = $1,200 · $25 = $1,500. Virtual style money has no cash value, cannot be withdrawn, transferred for cash, or exchanged for real currency.</p>
  </div>
</section>
'''
...
def topup_home():
    html = _original_home()
    note = '''<section style="max-width:980px;margin:20px auto;padding:0 18px"><div class="card" style="padding:18px 20px"><strong>Plans &amp; Virtual Style Money</strong><p class="sub" style="margin:7px 0 12px">Subscribers can add more virtual money only in $5.00 increments: $5, $10, $15, $20, $25 and so on. Every $5 adds $300 virtual style money.</p><div style="display:flex;gap:10px;flex-wrap:wrap"><a class="btn" href="/plans-virtual-money">View Plans &amp; Virtual Money</a><a class="btn alt" href="/style-money/topup">Add Virtual Money</a></div></div></section>'''
...
<main class="shell">
  ...
  <section style="max-width:1000px;margin:0 auto 28px">
    <div class="card" style="padding:24px;border:1px solid #57334a">
      ...
      <h2 style="margin:8px 0">Only Multiples of $5.00</h2>
      <p class="sub" style="line-height:1.7">Active subscribers can purchase additional virtual style money only in $5.00 increments. Allowed payment totals are $5, $10, $15, $20, $25 and so on. No in-between amounts are offered.</p>
      <p class="sub" style="line-height:1.7"><strong>$5 = $300 virtual</strong> · <strong>$10 = $600 virtual</strong> · <strong>$15 = $900 virtual</strong> · <strong>$20 = $1,200 virtual</strong> · <strong>$25 = $1,500 virtual</strong>.</p>
      <a class="btn" href="/style-money/topup">Add Virtual Money</a>
    ...
    def do_GET(self):
        ...
        if path == '/style-money/topup':
            ...
            if SQUARE_STYLE_TOPUP_URL:
                ...
                self.end_headers()
                return
            return self.sh(base.page('Add Virtual Style Money — What Bout Us™', '<main class="shell"><div class="card"><div class="grad">VIRTUAL STYLE MONEY</div><h1>Only $5.00 Increments</h1><p class="sub">Choose $5, $10, $15, $20, $25 or another multiple of $5. Every $5.00 adds $300 virtual style money. No in-between amounts are allowed. The secure Square payment link still needs to be connected before purchases can be processed.</p><a class="btn alt" href="/plans-virtual-money">How Plans &amp; Virtual Money Work</a></div>'+base.footer()+'</main>'))
        return super().do_GET()
